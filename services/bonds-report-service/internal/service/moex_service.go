...
func (s *Service) GetSpecificationsFromMoex(ctx context.Context, ticker string, date time.Time) (data domain.ValuesMoex, err error) {
	...
	data, err = s.External.Moex.GetSpecifications(ctx, ticker, date)
	if err != nil {
